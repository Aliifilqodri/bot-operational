...
import jwt_decode from 'jwt-decode'; // Import jwt-decode untuk mengambil username
...
function DashboardPage() {
  ...
  // --- PENAMBAHAN: State untuk menyimpan nama user ---
  ...
  // --- PENAMBAHAN: useEffect untuk mengambil username dari token saat komponen dimuat ---
  useEffect(() => {
 ...
 return (
    <>
      ...
      {/* --- PENAMBAHAN: Latar belakang abu-abu & layout container baru --- */}
      <div style={{ backgroundColor: '#f8f9fa' }}>
        <div className="container py-4">
          
          {/* --- PENAMBAHAN: Header baru dengan sapaan selamat datang --- */}
          ...
          {/* --- PENAMBAHAN: Chart dibungkus dalam card dengan grid responsif --- */}
          <div className="row g-4 mb-4">
          ...
          {/* --- PENAMBAHAN: Filter & List Tiket dibungkus dalam satu card besar --- */}
