      ...
      <div className="container my-5">
        ...
        <div className="dashboard-wrapper">
          ...
          <div style={{ gridColumn: '1 / -1' }}>
            ...
            {/* --- Ticket List Grid --- */}
            <div className="ticket-list d-flex flex-wrap gap-3 mt-3">
              {tickets.length > 0 ? (
                tickets.map(ticket => (
                  <div key={ticket._id} className="ticket-card-wrapper" style={{ flex: '1 1 calc(33.333% - 1rem)', minWidth: '250px' }}>
                    <TicketCard 
                      ticket={ticket} 
                ...
                <div className="alert alert-warning text-center w-100">Tidak ada kendala yang cocok dengan filter.</div>
              )}
            </div>
