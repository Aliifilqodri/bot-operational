...
function DashboardPage() {
  ...
  return (
    // --- PENAMBAHAN CLASS `bg-light` UNTUK LATAR BELAKANG ---
    <div className="bg-light min-vh-100"> 
      <Toaster position="top-center" />
      <div className="container py-5">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h1 className="h3">📊 Dashboard Kendala Operational</h1>
        ...
        <div className="dashboard-wrapper">
          <div className="chart-box panel">
              <h6 className="fw-bold">Statistik Pengerjaan</h6>
          ...
          <div className="chart-box">
              ...
              {stats.caseData && Object.keys(stats.caseData).length > 0 ? 
                ...
                <div className="alert alert-info text-center small p-2">Tidak ada data case.</div>
              }
          </div>
          <div className="chart-box">
          ...
          <div style={{ gridColumn: '1 / -1' }}>
            ...
            {totalPages > 1 &&
              <div className="pagination mt-3 d-flex justify-content-center gap-2">
                ...
                <span className="align-self-center text-muted small">Halaman {currentPage} dari {totalPages}</span>
