...
import { jwtDecode } from 'jwt-decode'; // Pastikan package ini sudah di-install
    ...
    <>
      ...
      <div style={{ backgroundColor: '#f8f9fa' }}>
        <div className="container py-4">
          ...
          {/* --- HEADER BARU DENGAN SAPAAN SELAMAT DATANG --- */}
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-body p-4">
              ...
              {/* --- PENAMBAHAN: UCAPAN SEMANGAT --- */}
              <div className="alert alert-info text-center" role="alert">
                🔥 Semangat bekerja! Mari selesaikan semua kendala hari ini. 🔥
              </div>
