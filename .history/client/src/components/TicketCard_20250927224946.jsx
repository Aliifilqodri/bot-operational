    ...
    <div style={{ 
      ...
      <div style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '20px' }}>
        <div>
          ...
          {/* --- PERUBAHAN FINAL: Area tombol ini selalu ada, tapi isinya kondisional --- */}
          <div style={{ marginTop: '16px', display: 'flex', alignItems: 'center', gap: '12px', minHeight: '36px' /* Kunci agar ruang selalu ada */ }}>
            {ticket.photoUrl && (
