      ...
      <div style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', padding: '20px' }}>
        ...
        <div>
          <p style={{ 
              ...
              // KUNCI #1: Tinggi blok teks dipaksa sama untuk semua kartu
              height: '77px' // Estimasi tinggi untuk 3 baris teks
            }}>
            {ticket.text || <em style={{color: CONFIG.COLORS.text.secondary}}>(Tidak ada deskripsi)</em>}
          </p>
          
          {/* KUNCI #2: Blok tombol juga dipaksa punya tinggi yang sama */}
        ...
        {/* Spacer yang akan mendorong footer ke bawah */}
        <div style={{ flexGrow: 1 }}></div>

        {/* Blok Bawah (Info Detail) */}
        <div style={{ borderTop: `1px solid ${CONFIG.COLORS.border}`, paddingTop: '20px' }}>
