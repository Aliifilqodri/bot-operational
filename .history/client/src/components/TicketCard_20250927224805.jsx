...
function TicketCard({ ticket, picList, refreshData, onImageClick, onTextClick }) {
  ...
  return (
    // --- PERUBAHAN 1: Menetapkan minHeight agar semua kartu sama tinggi ---
    <div style={{ 
      backgroundColor: '#fff', 
      borderRadius: '16px', 
      ...
      height: '100%',
      minHeight: '560px' // Tinggi minimum untuk semua kartu
    }}>
      ...
      {/* --- PERUBAHAN 2: Menampilkan area balasan ATAU placeholder selesai --- */}
      {ticket.status.toLowerCase() !== 'done' ? (
        // JIKA TIKET BELUM SELESAI, TAMPILKAN AREA AKSI
        ...
        // JIKA TIKET SUDAH SELESAI, TAMPILKAN PLACEHOLDER
