...
// --- DAFTAR STATUS BARU ---
const STATUS_LIST = ['Diproses', 'On Hold', 'Menunggu Appro', 'Done'];
      ...
      <div style={{ padding: '20px', borderTop: `1px solid ${CONFIG.COLORS.border}`, backgroundColor: '#fdfdfd' }}>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.9rem', color: CONFIG.COLORS.text.primary }}>
            ...
            {completedDate ? (
              <span style={{ fontWeight: '600', color: CONFIG.COLORS.done?.text || CONFIG.COLORS.text.primary }}>{completedDate}</span>
            ) : (
