...
router.get('/', authMiddleware, async (req, res) => {
    try {
        ...
        const stats = {}; // bisa ditambahkan nanti
...
// [PATCH] Balas tiket ke array replies
router.patch('/reply/:id', authMiddleware, async (req, res) => {
  try {
    ...
    ticket.replies.push({ text: replyText, user: req.user.username });
    await ticket.save();
